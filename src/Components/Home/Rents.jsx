            ...
            <div className="relative z-10 mx-auto max-w-[1280px] px-6 md:px-8">
                ...
                <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3 mb-16">
                    {RENTS?.map((r, i) => (
                        <div
                            key={r.label}
                            className="group relative rounded-[18px] border border-[rgba(127,176,105,0.15)] bg-[rgba(13,43,26,0.25)] p-8 text-center transition-all duration-500 ease-[cubic-bezier(.22,1,.36,1)] hover:-translate-y-2 hover:border-[rgba(201,168,76,0.35)] hover:bg-[rgba(26,92,53,0.28)] overflow-hidden"
                        >
                            {/* Corner accent line */}
                            ...
                            <div className="relative">
                                ...
                                <div className="mb-3 text-[0.68rem] uppercase tracking-[0.18em] text-[rgba(192,212,184,0.45)]">
                                    {r.label}
                                </div>
                ...
                <div className="group relative overflow-hidden rounded-[28px] border border-[rgba(127,176,105,0.2)]">
                    ...
                    <div
                        className="absolute inset-0 bg-cover bg-center transition-transform duration-[8s] ease-linear group-hover:scale-105"
                        style={{
                            backgroundImage: `url('https://images.unsplash.com/photo-1516912481808-3406841bd33c?w=1600&q=80')`,
                        }}
                    />
                    {/* Gradient overlay: heavy on left, lighter on right */}
                    <div className="absolute inset-0 bg-[linear-gradient(105deg,rgba(4,18,10,0.96)_0%,rgba(6,30,16,0.88)_45%,rgba(8,40,20,0.7)_100%)]" />
                    ...
                    <div className="relative z-10 flex flex-col gap-8 p-10 sm:p-14 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div className="max-w-[42rem]">
                            ...
                            {/* ── IMAGE-MASKED HEADLINE ── */}
                            <h3
                                className="mb-2 leading-[1.1] font-light"
                                style={{
                            ...
                            <p className="text-sm leading-[1.9] text-[rgba(192,212,184,0.6)] max-w-[30rem]">
                                The rain transforms every forest, lake and valley into something otherworldly.
                                Book any retreat this season and receive an exclusive monsoon discount.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-start gap-4 lg:items-end lg:shrink-0">
                            ...
                            {/* Expiry */}
                            <span className="text-[0.65rem] text-[rgba(192,212,184,0.35)] tracking-wide">
